...
namespace Niflib
{
    ...
    public class NiPSysModifierActiveCtlr : NiPSysModifierBoolCtlr
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NiPSysModifierActiveCtlr"/> class.
        /// </summary>
        /// <param name="file">The file.</param>
        /// <param name="reader">The reader.</param>
        public NiPSysModifierActiveCtlr(NiFile file, BinaryReader reader) : base(file, reader)
        {
